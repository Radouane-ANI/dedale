...
public class Principal {
	...
	/**
	 * Create user agents by loading the json entities file and add them to the
	 * platform.
	...
	// from the agentCaracteristics
	private static AgentController createNewDedaleAgent2(ContainerController initialContainer,
			Object[] agentCaracteristics) {
